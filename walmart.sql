...
----- created table and import the data from csv file----------

select * from sales;

-------- created a views to add derived column from date and time from sales table--------------------
...
create view date_time as
  ...
  case
  when time between "0:00:00" and "12:00:00" then "morning"
...
SELECT d.time_of_day, AVG(rating) AS average_rating 
FROM sales s,
date_time as d 
where s.invoice_id=d.invoice_id
GROUP BY d.time_of_day ORDER BY average_rating DESC LIMIT 1;

-- 8.Which time of the day do customers give most ratings per branch?
SELECT s.branch, d.time_of_day, AVG(rating) AS average_rating
FROM sales as s,
date_time as d 
where s.invoice_id=d.invoice_id
GROUP BY s.branch, d.time_of_day ORDER BY  average_rating DESC;
